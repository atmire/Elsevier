...
public class LiveImportStep extends AbstractSubmissionStep {
            ...
            UIException, SQLException, IOException, AuthorizeException
    {
        ...
        String importSourceString = submission.getItem().getMetadata("workflow.import.source");
        ...
        form.addItem().addContent(T_lookup_help);
            ...
            if (fieldValues.size() > 0 && StringUtils.isBlank(request.getParameter("import_id"))) {
                ...
                if (total > 0) {
                    ...
                    for (Record record : records) {
                        ...
                        java.util.Collection<Metadatum> eid = record.getValue(importSource.getIdField());
            ...
            com.atmire.import_citations.configuration.metadatamapping.MetadataField importIdField = new com.atmire.import_citations.configuration.metadatamapping.MetadataField(importSource.getIdField());
