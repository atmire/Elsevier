 ...
 */
package com.atmire.dspace.app.xmlui.aspect.submission.submit;
 ...
 */
public class ElsevierUploadStep extends AbstractSubmissionStep {
    ...
    public void addBody(Body body) throws SAXException, WingException,
        ...
        if (!disableFileEditing) {
            ...
            if (openAccess != null) {
                ...
                if(org.apache.commons.lang3.StringUtils.isNotBlank(link)) {
            ...
            boolean fileAccessError = this.errorFlag == com.atmire.dspace.submit.step.ElsevierUploadStep.STATUS_NO_FIlE_ACCESS_ERROR;
        ...
        if (bitstreams.length > 0 || disableFileEditing) {
            ...
            for (Bitstream bitstream : bitstreams) {
                ...
                ArticleAccess fileAccess = FileAccess.getFileAccess(context, bitstream);
                ...
                checksumRow.addCell();
                Cell checksumCell = checksumRow.addCell(null, null, 0, 7, null);
            ...
            if (!disableFileEditing) {
                ...
                actionRow.addCell();
                Button removeSeleceted = actionRow.addCell(null, null, 0, 7, null).addButton("submit_remove_selected");
