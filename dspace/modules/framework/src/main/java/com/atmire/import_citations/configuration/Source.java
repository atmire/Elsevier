...
public abstract class Source {
     ...
     */
    protected <T> T retry(Callable<T> callable) throws SourceException {
        ...
        while (true) {
            try {
                ...
                // No SourceException has interrupted the loop
                retry++;
    ...
    protected void handleException(int retry, Exception e, String operationId) throws SourceException {
    ...
    protected void throwSourceException(int retry, Exception e, String operationId) throws SourceException {
        throwSourceExceptionHook();
//        log.error("Source exception", e);
        log.error("Source exception " + e.getMessage());
        throw new SourceException("At retry of operation " + operationId + " " + retry, e);
    }
